...
public class HostServletTest {
    ...
    public void testDoPost_SC_OK() throws IOException, ServletException {
        ...
        String expectedResult = "{\"host\":[{\"host_id\":2,\"ip\":\"10.0.0.2\",\"identity\":\"host_2\",\"deviceList\":[{\"device_id\":2,\"vendor\":\"vendor_2\",\"hardware\":\"hardware_2\",\"software\":\"software_2\",\"serviceList\":[{\"service_id\":2,\"port\":2,\"name\":\"name_2\"},{\"service_id\":3,\"port\":3,\"name\":\"name_3\"}],\"addition\":\"addition_2\"}],\"login\":\"login_2\",\"password\":\"password_2\"}]}";
